...
*/
    ...
    public Message addNewMessageService(Message message){
...
*/        
    ...
    public int deleteMessagebyIdService(int message_id){
        Optional<Message> messageOptional = messageRepository.findById(message_id);
        if(messageOptional.isPresent()){
...
*/
    public int updateMessageByIdService(int message_id, Message replacement){
        Optional<Message> messageOptional = messageRepository.findById(message_id);
        if((messageOptional.isPresent())){
...
*/
    ...
    public List<Message> getMessagesOfAUserService(int account_id){
        Optional<List<Message>> listOptional = messageRepository.findByPostedBy(account_id);
